...
export type GetDefaultVaultsQuery = { __typename?: 'Query', getDefaultVaults: { __typename?: 'GetDefaultVaultsOutput', count: number, hasNext: boolean, hasPrev: boolean, totalPages: number, vaults: Array<{ __typename?: 'VaultsEntity', creatorId: string, description?: string | null, id: string, keywords?: Array<string> | null, createdAt: any, preview: string, creatorProfile: { __typename?: 'CreatorProfilesEntity', bio?: string | null, creatorId: string, user: { __typename?: 'UsersEntity', avatarUrl?: string | null, bannerUrl?: string | null, id: string, username: string } } }> } };
